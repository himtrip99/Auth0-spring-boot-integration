...
public class APIControllerTest {
    ...
    @Test
    public void testGetApplicationActionsEndpointReturnsUnauthorizedWhenNoUser() throws Exception {
        mockMvc.perform(get("/api/getApplicationActions"))
                .andDo(print())
                .andExpect(status().isUnauthorized())
                .andReturn();
    }
    ...
    @Test
    @WithMockUser(username = "testUser")
    public void testGetApplicationActionsEndpointReturnsForbiddenWhenNoScopes() throws Exception {
        mockMvc.perform(get("/api/getApplicationActions"))
                .andDo(print())
                .andExpect(status().isForbidden())
                .andReturn();
    ...
    @Test
    @WithMockUser(username = "testUser", authorities = {"SCOPE_read:messages"})
    public void testGetApplicationActionsEndpointReturnsOkWhenProperScopes() throws Exception {
        MvcResult mvcResult = mockMvc.perform(get("/api/getApplicationActions"))
                .andDo(print())
                .andExpect(status().isOk())
                .andReturn();
    ...
    @Test
    @WithMockUser(username = "testUser", authorities = {"SCOPE_write:messages"})
    public void testGetApplicationActionsEndpointReturnsForbiddenWhenIncorrectScopes() throws Exception {
        mockMvc.perform(get("/api/getApplicationActions"))
                .andDo(print())
                .andExpect(status().isForbidden())
                .andReturn();
